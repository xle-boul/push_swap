...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   check_listen_to_stdin_color_bonus.c                :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: xle-boul <xle-boul@student.s19.be>         +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/26 01:21:11 by xle-boul          #+#    #+#             */
/*   Updated: 2022/05/26 12:11:07 by xle-boul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/checker_bonus.h"

void	ft_move_from_input_2_color(char *line, t_stack **a, t_stack **b)
{
	if (line[0] == '\0')
		ft_end_checker_color(line, a, b);
	else
...
void	ft_move_from_input_no_print(char *line, t_stack **a, t_stack **b)
{
	if (ft_strncmp(line, "sa", 2) == 0 && ft_strlen(line) == 2)
		...
		ft_move_from_input_2_color(line, a, b);
}
